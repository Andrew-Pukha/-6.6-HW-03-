...
class News(models.Model):
    ...
    author = models.OneToOneField('Author', on_delete=models.SET_NULL, null=True,
                                  blank=True, related_name='wuman', verbose_name='Автор')                                                                                                                    #-- related_name='tags' чтобы мы могли через ТЭГи получать список статей\новостей, которые связаны с этим тэгом.
